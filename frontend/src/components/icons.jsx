/** Inline SVG icons for HealthChain UI (mockup-aligned). */

export function IconLogo({ className = "h-8 w-8" }) {
  return (
    <svg className={className} viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden>
      <path
        ...
        strokeLinecap="round"
      />
      <rect x="6" y="6" width="8" height="8" rx="1.5" stroke="currentColor" strokeWidth="1.8" fill="none" />
      <rect x="18" y="6" width="8" height="8" rx="1.5" stroke="currentColor" strokeWidth="1.8" fill="none" />
      <rect x="6" y="18" width="8" height="8" rx="1.5" stroke="currentColor" strokeWidth="1.8" fill="none" />
      <rect x="18" y="18" width="8" height="8" rx="1.5" stroke="currentColor" strokeWidth="1.8" fill="none" />
    </svg>
  );
}
...
export function IconUploadNav({ className = "h-4 w-4" }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8} aria-hidden>
...
export function IconUserPlus({ className = "h-5 w-5" }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8} aria-hidden>
...
export function IconShieldSolid({ className = "h-6 w-6" }) {
  return (
...
export function IconUsersSolid({ className = "h-6 w-6" }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor" aria-hidden>
...
export function IconCube({ className = "h-6 w-6" }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor" aria-hidden>
